...
public class PaymentOutboxJpaEntity {
    @Id
    private UUID id;
    ...
    protected PaymentOutboxJpaEntity() {
    }

    public PaymentOutboxJpaEntity(UUID aggregateId, String eventType, String topic, String messageKey, String payload) {
